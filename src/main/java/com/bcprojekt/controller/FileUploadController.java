...
public class FileUploadController {
    private static final Logger LOGGER = org.slf4j.LoggerFactory.getLogger(FileUploadController.class);
    ...
    String handleFileUpload(@RequestParam("file") MultipartFile file, HttpServletRequest request) {
        File resourcesPath = new File(request.getSession().getServletContext().getRealPath("/"), "resources/images/");
